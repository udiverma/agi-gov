...
// Initialize Globe with adjusted settings for better integration
const myGlobe = Globe()
...
// Adjust initial view based on header height
const header = document.querySelector('header');
const headerHeight = header ? header.offsetHeight : 0;
document.getElementById('globeViz').style.height = `calc(100vh - ${headerHeight}px)`;
document.getElementById('globeViz').style.top = `${headerHeight}px`;
...
// Handle window resize to adjust globe size
...
// Display dashboard initially after a short delay
setTimeout(() => {
    dashboardElement.classList.add('open');
}, 1000);